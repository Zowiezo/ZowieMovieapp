...
import Casts from "./components/Cast.js";
import Videos from "./components/Video.js";
import Genre from "./components/Genre.js";
import { useGetShowQuery } from "../../api/index.js";
import { useMotion } from "../../hooks/useMotion.js";
import { mainHeading, maxWidth, paragraph } from "../../styles/index.js";
...
const Detail = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      document.title = "Pink Unicorn Movies";
    };
